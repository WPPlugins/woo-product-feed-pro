					...
					<td colspan="6">
							...
							<input type="hidden" name="project_hash" value="<?php print "$project[project_hash]";?>">
        	        		                <input type="hidden" name="step" value="100">
                	               			<input type="button" class="delete-field-mapping" value="- Delete field mapping">&nbsp;<input type="button" class="add-field-mapping" value="+ Add field mapping">&nbsp;<input type="submit" value="Save field mappings" />
