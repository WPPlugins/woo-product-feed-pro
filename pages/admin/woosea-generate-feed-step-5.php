...
?>
	<div class="wrap">
		...
		<table class="woo-product-feed-pro-table">
			...
			<div class="form-style-2-heading">Add Google Analytics tracking</div>
			...
			<form action="" method="post">
				...
				<tr>
					<td><span>Campaign source (utm_source): <span class="required">*</span></span></td>
				 	<td><input type="text" class="input-field" name="utm_source" value="<?php print "$project[utm_source]";?>" /></td>
				</tr>
				<tr>
					<td><span>Campaign medium (utm_medium):</span></td>
				 	<td><input type="text" class="input-field" name="utm_medium" value="<?php print "$project[utm_medium]";?>" /></td>
				</tr>
				<tr>
					<td><span>Campaign name (utm_campaign):</span></td>
				 	<td><input type="text" class="input-field" name="utm_campaign" value="<?php print "$project[utm_campaign]";?>" /></td>
				</tr>
				<tr>
					<td><span>Campaign term (utm_term):</span></td>
				 	<td><input type="hidden" name="utm_term" value="id"><input type="text" class="input-field" value="[productId]" disabled/> <i>("id" product attribute)</i></td>
				</tr>
				<tr>
					<td><span>Campaign content (utm_content):</span></td>
